  ...
  return (
    <>
      ...
      <div className="hidden lg:block fixed left-0 top-0 h-full w-64 bg-gray-50 border-r border-gray-200 text-gray-800 z-50">
        <div className="p-6">
          <Link href="/" className="font-bold text-xl block mb-8 text-gray-900 hover:text-blue-600 transition-colors">MeuApp</Link>
          ...
          <nav className="space-y-2">
            <Link href="/" className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white hover:shadow-sm transition-all text-gray-700 hover:text-blue-600">
              <Home className="h-4 w-4" />
              <span>Dashboard</span>
            </Link>
            <Link href="/produtos" className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white hover:shadow-sm transition-all text-gray-700 hover:text-blue-600">
              <Package className="h-4 w-4" />
              <span>Produtos</span>
            </Link>
            <Link href="/faturas" className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white hover:shadow-sm transition-all text-gray-700 hover:text-blue-600">
      ...
      {drawerOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-40 flex">
          ...
          <div className="bg-gray-50 w-64 h-full p-6 flex flex-col gap-4 shadow-lg animate-slide-in-right border-l border-gray-200">
            ...
            <nav className="space-y-2">
              <Link href="/" onClick={() => setDrawerOpen(false)} className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white hover:shadow-sm transition-all text-gray-700 hover:text-blue-600">
                <Home className="h-4 w-4" />
                <span>Dashboard</span>
              </Link>
              <Link href="/produtos" onClick={() => setDrawerOpen(false)} className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white hover:shadow-sm transition-all text-gray-700 hover:text-blue-600">
                <Package className="h-4 w-4" />
                <span>Produtos</span>
              </Link>
              <Link href="/faturas" onClick={() => setDrawerOpen(false)} className="flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-white hover:shadow-sm transition-all text-gray-700 hover:text-blue-600">
                <Receipt className="h-4 w-4" />
                <span>Faturas</span>
              </Link>
